...
public interface TdInterface {
	...
	int fileUp(int success, String j_category, String fileName, String newFileName);

	//idx받아오기
	int idxCall();

	//글쓰기
	int write(int j_idx, String u_idx, String j_category, String j_name, String j_title, String j_content);
