...
<html>
	<head>
		...
		<style>
		  .map_wrap {position:static;width:100%;height:350px;}
					...
					<table class="detailTable">
						<thead>
							...
							<tr class="borderBottom center">
								...
								<td class="borderLeft" style="width: 25%;">${detail.a_name}</td>
						...
						<tbody>
							<tr class="borderBottom">
								<td>주소</td>
								<td colspan="5" class="borderLeft left">
									&nbsp;${detail.a_address}
								</td>
							</tr>
							<tr class="borderBottom">
	...
	$("#repleGo").click(function(){
		...
		data.column="area_idx";
		data.table="area";
		data.repleCnt="a_reple";
		console.log(data);
		reqServer(url, data);
	});
